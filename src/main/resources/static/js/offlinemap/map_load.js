...
var online = parent.$('#online').text();
var mapLevel = parent.$('#mapLevel').text();
var lng = parent.$('#lng').text();
var lat = parent.$('#lat').text();
...
(function() {
    ...
    //加载城市坐标
    // <script type="text/javascript" src="'+offmapcfg.home+'map_city.js?v=2.1"></script>
    //document.write('<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=wlyiLpTGajwXdj9jSuwv2NQMDCdAz3M1"></script>');
